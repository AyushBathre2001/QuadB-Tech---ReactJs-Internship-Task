  ...
  let navigate = useNavigate()
    ...
    <div className="container px-5 py-24 mx-auto">
      <div className="lg:w-4/5 mx-auto flex flex-wrap">
        <img alt="img" className="lg:w-1/3 sm:h-[60vh] w-full lg:h-auto h-64 object-cover object-center rounded" src={selectedShow.img}/>
        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          ...
          <div className="flex">
            <button onClick={()=>{navigate('/book')}} className="flex  text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">Book</button>
